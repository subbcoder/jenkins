...
[Service]
WorkingDirectory=/var/lib/jenkins/workspace/api.subbnet.ru_Job/publish
ExecStart=/usr/bin/dotnet /var/lib/jenkins/workspace/api.subbnet.ru_Job/publish/api.subbnet.ru.dll --urls=${URLS_NAME}
Restart=always
RestartSec=30
...
WantedBy=multi-user.target"""
                ...
                sh "sudo -S chown -R nginx:nginx /var/lib/jenkins/workspace/api.subbnet.ru_Job/publish/*"
                ...
                // Удалить файл сервиса. Если он существует.
